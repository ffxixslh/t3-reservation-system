...
type DoctorAppointmentFormValues = z.infer<
...
export const DoctorAppointmentForm: React.FC<
...
> = ({ initialData, departments }) => {
  ...
  const defaultValues: DoctorAppointmentFormValues =
    initialData ?? {
      id: "",
      status: "PENDING",
      time: new Date(),
  ...
  const form = useForm<DoctorAppointmentFormValues>({
  ...
  const onSubmit = async (
    data: DoctorAppointmentFormValues,
  ) => {
    ...
    try {
      ...
      router.push(
        `/doctor/${session?.user.doctorId}/appointments`,
      );
